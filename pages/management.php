...
<div class="main-block"><!-- Сторінка керування -->
    <?php if ($accessControl->getUserLevel($_SESSION['login']) == 2) { ?>
        ...
        <div class="userlist"><!-- Таблиця керування користувачами -->
            ...
            <table>
                <tr>
                    ...
                    <th width="200">Керування користувачем</th>
                </tr>
        ...
        <div class="news"><!-- Таблиця взаємодії з новинами -->
            ...
            <table>
                <tr>
                    <th width="100">Зображення</th>
                    <th width="100">Назва</th>
                    <th>Опис</th>
                    <th width="90">Початкова дата</th>
                    <th width="90">Кінцева дата</th>
                </tr>
    ...
    if ($accessControl->getUserLevel($_SESSION['login']) >= 1) { ?>
        <div class="category"><!-- Таблиця взаємодії з категоріями -->
            ...
            <table>
                <tr>
                    ...
                    <th>Назва</th>
                    <th>Опис</th>
                    <th width="80">Кількість товарів</th>
                    <th width="150">Специфікації</th>
                </tr>
        ...
        <?php if ($selectedCategory != "") { ?><!-- Якщо категорія обрана -> вивести цей товар -->
            <div class="products"><!-- Таблицяя взаємодії з товарами певної категорії -->
                <h1>Список товарів <?php echo $selectedCategory ? 'категорії "' . htmlspecialchars($selectedCategory) . '"' : ''; ?>
                </h1>
                <table>
                    <tr>
                        <th width="100">Зображення</th>
                        ...
                        <th>Назва товару</th>
                        <th width="50">Ціна</th>
                        <th width="125">Характеристики</th>
                    </tr>
